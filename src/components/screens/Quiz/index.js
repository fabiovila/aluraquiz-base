...
function LoadingWidget({externalQuestions}) {
  return (
    <Widget>
      ...
      <BoxBlink color={externalQuestions.theme.colors.wrong} height="150px" />
      <Widget.Content>
        <BoxBlink color={externalQuestions.theme.colors.wrong} />
        <BoxBlink color={externalQuestions.theme.colors.wrong} width="50%" />
        <BoxBlink color={externalQuestions.theme.colors.wrong} width="50%" />
      </Widget.Content>
    </Widget>
  );
  ...
  return (
    <QuizBackground backgroundImage={externalQuestions.bg}>
      <QuizContainer>
        ...
        {screenState === screenStates.LOADING && <LoadingWidget externalQuestions={externalQuestions} />}
